...
public class RDFConverter extends AbstractProcessor {
        ...
        try{
            flowFile = session.write(flowFile,new StreamCallback() {
                ...
                public void process(InputStream inputStream, OutputStream outputStream) throws IOException {
                    ...
                    RDFWriter rdfWriter = Rio.createWriter(RDFFormat.JSONLD, outputStream);
                    logger.debug("INLINE_BLANK_NODES HIERARCHICAL_VIEW USE_RDF_TYPE");
                    ...
                    rdfWriter.getWriterConfig().set(JSONLDSettings.USE_RDF_TYPE, true);
